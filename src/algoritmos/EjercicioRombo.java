...
public class EjercicioRombo {
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			crearRombo(fila, solid);
			
			System.out.println("");
		}
	}
	
	private static int alturaRombo() {
		boolean c;
		int fila;
		do {
	...
	private static void crearRombo(int fila, boolean solid) {
		int n = 1;
		int p=fila;
		int col = anchoRombo(fila);
		fila=fila >>1;
		...
		//Línea central (solo si es impar)
	...
	private static int anchoRombo(int fila) {
		int col = 1;
